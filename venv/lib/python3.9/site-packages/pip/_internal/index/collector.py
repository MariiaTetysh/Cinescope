...
def _determine_BASE_URL_AUTH(document: HTMLElement, page_url: str) -> str:
...
def _create_link_from_element(
    ...
    url = _clean_link(urllib.parse.urljoin(BASE_URL_AUTH, href))
...
def _parse_links_html5lib(page: "HTMLPage") -> Iterable[Link]:
    ...
    url = page.url
    BASE_URL_AUTH = _determine_BASE_URL_AUTH(document, url)
...
def parse_links(page: "HTMLPage", use_deprecated_html5lib: bool) -> Iterable[Link]:
    ...
    url = page.url
    BASE_URL_AUTH = parser.BASE_URL_AUTH or url
...
class HTMLLinkParser(HTMLParser):
    ...
    def __init__(self, url: str) -> None:
        ...
        self.url: str = url
        self.BASE_URL_AUTH: Optional[str] = None
        self.anchors: List[Dict[str, Optional[str]]] = []

    def handle_starttag(self, tag: str, attrs: List[Tuple[str, Optional[str]]]) -> None:
        if tag == "base" and self.BASE_URL_AUTH is None:
            href = self.get_href(attrs)
            if href is not None:
                self.BASE_URL_AUTH = href
        elif tag == "a":
